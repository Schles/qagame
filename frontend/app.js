...
/***/ function(module, exports, __webpack_require__) {
	...
	var login_component_1 = __webpack_require__(57);
	var question_component_1 = __webpack_require__(355);
	var admin_detail_component_1 = __webpack_require__(358);
	var admin_list_component_1 = __webpack_require__(359);
	var app_routes_1 = __webpack_require__(360);
	var auth_guard_1 = __webpack_require__(361);
	var auth_service_1 = __webpack_require__(58);
	...
	var AppModule = (function () {
	    ...
	    AppModule = __decorate([
	        core_1.NgModule({
	            imports: [platform_browser_1.BrowserModule, http_1.HttpModule, router_1.RouterModule.forRoot(app_routes_1.ContactsAppRoutes), forms_1.FormsModule],
	            declarations: [app_component_1.AppComponent, login_component_1.LoginComponent, question_component_1.QuestionComponent, admin_list_component_1.AdminListComponent, admin_detail_component_1.AdminDetailComponent],
	            providers: [auth_guard_1.AuthGuard, auth_service_1.AuthService, { provide: common_1.LocationStrategy, useClass: common_1.HashLocationStrategy }],
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	     true ? factory(exports, __webpack_require__(3), __webpack_require__(56), __webpack_require__(4), __webpack_require__(5), __webpack_require__(51)) :
	...
	var LoginComponent = (function () {
	    ...
	    LoginComponent.prototype.login = function () {
	        if (this.userName.length > 0) {
	            var uId = this.hashCode(this.userName);
	            this.authService.setUserId(uId);
	            var url = this.authService.getRedirectUrl();
	            if (url.length == 0)
	                url = "/q/1";
	            console.log(url);
	    ...
	    LoginComponent.prototype.hashCode = function (str) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(3);
	var question_service_1 = __webpack_require__(356);
	var auth_service_1 = __webpack_require__(58);
	var router_1 = __webpack_require__(24);
	var question_1 = __webpack_require__(357);
	var QuestionComponent = (function () {
	    function QuestionComponent(questionService, authService, router, route) {
	        var _this = this;
	        ...
	        this.setAnswer = function (aId) {
	            _this.questionService.setAnswer(_this.qId, aId, _this.uId).subscribe(function (data) {
	                var votes = JSON.parse(data._body);
	                _this.question.voteCount = 0;
	                _this.question.hasVoted = true;
	    ...
	    QuestionComponent.prototype.ngOnInit = function () {
	        ...
	        this.route.params.forEach(function (params) {
	            _this.qId = +params["id"];
	            console.log("Hallo " + _this.qId);
	            _this.questionService.getQuestion(_this.uId, _this.qId).subscribe(function (data) { return _this.question = data; }, function (error) { return _this.error = "error"; });
	        });
	    };
	    ...
	    QuestionComponent.prototype.nextQuestion = function () {
	        var _this = this;
	        this.questionService.getNextQuestionId(this.uId).subscribe(function (data) {
	            _this.router.navigate(['/q/', data]);
	        }, function (error) { return _this.error = "error"; });
	    };
	    QuestionComponent = __decorate([
	        core_1.Component({
	            ...
	            providers: [question_service_1.QuestionService, auth_service_1.AuthService]
	        }), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QuestionService = (function () {
	    ...
	    QuestionService.prototype.getQuestion = function (uId, qId) {
	        var headers = new http_1.Headers({ 'authToken': uId });
	        var options = new http_1.RequestOptions({ headers: headers });
	        return this.http.get('/data/q/' + qId, options).map(function (res) { return res.json(); });
	    };
	    QuestionService.prototype.setAnswer = function (qId, aId, uId) {
	        var body = JSON.stringify({ qId: qId, aId: aId, uId: uId });
	        var headers = new http_1.Headers({ 'Content-Type': 'application/json' });
	        var options = new http_1.RequestOptions({ headers: headers });
	        return this.http.post('/data/q', body, options);
	    };
	    QuestionService.prototype.newQuestion = function (question, answers, uId) {
	        var body = JSON.stringify({ question: question, answers: answers });
	        var headers = new http_1.Headers({ 'Content-Type': 'application/json', 'authToken': uId });
	        var options = new http_1.RequestOptions({ headers: headers });
	        return this.http.post('/control/q/new', body, options);
	    };
	    QuestionService.prototype.getQuestionList = function (uId) {
	        var headers = new http_1.Headers({ 'authToken': uId });
	        var options = new http_1.RequestOptions({ headers: headers });
	        return this.http.get('/control/q', options).map(function (res) { return res.json(); });
	    };
	    QuestionService.prototype.deleteQuestion = function (uId, qId) {
	        var body = JSON.stringify({ qId: qId });
	        var headers = new http_1.Headers({ 'Content-Type': 'application/json', 'authToken': uId });
	        var options = new http_1.RequestOptions({ headers: headers });
	        return this.http.post('/control/q/delete', body, options);
	    };
	    QuestionService.prototype.getNextQuestionId = function (uId) {
	        var headers = new http_1.Headers({ 'authToken': uId });
	        var options = new http_1.RequestOptions({ headers: headers });
	        return this.http.get('/data/nextQ', options).map(function (res) { return res.json(); });
	    };
...
/***/ function(module, exports) {
	...
	var Question = (function () {
	    ...
	    Question.prototype.hallo = function () {
	        console.log("huhu");
	    };
	    return Question;
	}());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AdminDetailComponent = (function () {
	    function AdminDetailComponent(questionService, authService, router, route) {
	        this.questionService = questionService;
	        this.authService = authService;
	        this.router = router;
	        this.route = route;
	    ...
	    AdminDetailComponent.prototype.ngOnInit = function () {
	        ...
	        this.route.params.forEach(function (params) {
	            ...
	            if (isNaN(_this.qId))
	                ...
	                console.log("Hallo " + _this.qId);
	                _this.questionService.getQuestion(_this.uId, _this.qId).subscribe(function (data) {
	                    console.log(data);
	                    _this.question = data.qText;
	                    _this.answers = data.answers;
	                }, function (error) { return _this.error = "error"; });
	            }
	        });
	    };
	    AdminDetailComponent.prototype.addQuestion = function () {
	        var _this = this;
	        this.questionService.newQuestion(this.question, this.answers, this.uId).subscribe(function (data) {
	            console.log("ist abgesendet" + data._body);
	            _this.router.navigate(['/admin', data._body]);
	        }, function (error) { return _this.error = "error"; });
	    };
	    AdminDetailComponent.prototype.addAnswer = function () {
	    ...
	    AdminDetailComponent.prototype.deleteQuestion = function () {
	        var _this = this;
	        this.questionService.deleteQuestion(this.uId, this.qId).subscribe(function (data) {
	            console.log("ist gelöscht");
	            _this.router.navigate(['/admin']);
	        }, function (error) { return _this.error = "error"; });
	    };
	    AdminDetailComponent.prototype.deleteAnswer = function (a) {
	        console.log(a);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AdminListComponent = (function () {
	    function AdminListComponent(questionService, authService, router, route) {
	        this.questionService = questionService;
	        this.authService = authService;
	        this.router = router;
	        this.route = route;
	    ...
	    AdminListComponent.prototype.ngOnInit = function () {
	        var _this = this;
	        this.uId = this.authService.getUserId();
	        this.questionService.getQuestionList(this.uId).subscribe(function (data) { return _this.questions = data; }, function (error) { return _this.error = "error"; });
	    };
	    AdminListComponent.prototype.onSelect = function (q) {
	        this.router.navigate(['/admin', q]);
	    };
	    AdminListComponent.prototype.newQuestion = function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ContactsAppRoutes = [
	    ...
	    { path: 'q/:id', component: question_component_1.QuestionComponent, canActivate: [auth_guard_1.AuthGuard] },
	    { path: 'admin', component: admin_list_component_1.AdminListComponent },
	    { path: 'admin/new', component: admin_detail_component_1.AdminDetailComponent },
	    { path: 'admin/:id', component: admin_detail_component_1.AdminDetailComponent },
	];
